...
class ContactCodeBlock extends HTMLElement {
  constructor() {
    super();
  ...
  render() {
    this.shadowRoot.innerHTML = `
      <style>
        ...
        h3, h4, h5 { margin: 5px 0; color: #fff; }
        ...
        /* Utility for focus instructions */
        .hint {
          font-size: 0.75rem;
          color: #666;
          margin-top: 10px;
      ...
      <div class="code-content">
        <slot name="code-content"></slot> <!-- Fallback if slot name missing -->
        <slot></slot> <!-- Default slot for content if not named -->
      </div>

      <div class="actions">
        <a class="action-btn btn-linkedin" href="#"><slot name="linkedin-url">LinkedIn</slot></a>
        <a class="action-btn btn-whatsapp" href="#"><slot name="whatsapp-url">WhatsApp</slot></a>
        <a class="action-btn btn-gmail" href="#"><slot name="gmail-url">Gmail</slot></a>
      </div>
      
      <div class="hint">Hover or Focus to activate. Click outside to blur.</div>
    `;
  }
